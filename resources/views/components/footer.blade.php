    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors">Cetak Stiker</a>
                    </li>
                    <li>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors">Banner & Spanduk</a>
                    </li>
                    <li>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors">Merchandise</a>
                    </li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors">Cara Pemesanan</a>
                    </li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Pengiriman</a></li>
                    <li>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors">Kebijakan Return</a>
                    </li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">FAQ</a></li>
                    <li>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors">Hubungi Kami</a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="space-y-3">
                    <div class="flex items-start">
                        <svg
                            class="w-5 h-5 text-red-500 mt-1 mr-3 flex-shrink-0"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
            ...
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-4 md:mb-0">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <div class="bg-white p-2 rounded">
                            <img
                                src="https://via.placeholder.com/60x30/ffffff/000000?text=DANA"
                                alt="DANA"
                                class="h-6"
                            />
                        </div>
                ...
                <div>
                    ...
                    <div class="flex space-x-3">
                        ...
                        <div class="bg-white p-2 rounded">
                            <img
                                src="https://via.placeholder.com/50x30/ffffff/000000?text=J%26T"
                                alt="J&T"
                                class="h-6"
                            />
                        </div>
                        <div class="bg-white p-2 rounded">
                            <img
                                src="https://via.placeholder.com/50x30/ffffff/000000?text=SiCepat"
                                alt="SiCepat"
                                class="h-6"
                            />
                        </div>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>
                &copy; 2024 TRIA DIGITAL. All rights reserved. |
