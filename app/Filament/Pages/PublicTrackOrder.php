...
class PublicTrackOrder extends Page
{
    protected static ?string $navigationIcon = 'heroicon-o-map-pin';

    protected static string $view = 'filament.pages.public-track-order';
    
    protected static ?string $navigationLabel = null; // Tidak ditampilkan di navigation
    
    protected static ?string $title = 'Lacak Pesanan';
    
    protected static ?string $slug = 'track-order';
    ...
    public function trackOrder(): void
    {
        ...
        // Cari order berdasarkan order_number saja (untuk public access)
        $order = Order::where('order_number', $this->orderNumber)->first();

        if (!$order) {
            Notification::make()
                ->title('Pesanan Tidak Ditemukan')
                ->body('Nomor pesanan yang Anda masukkan tidak ditemukan.')
                ->danger()
                ->send();
    ...
    {
        return false; // Tidak ditampilkan di navigation
    }
}